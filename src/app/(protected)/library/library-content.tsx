...
function RatingDropdown({ entryId, rating }: { entryId: string; rating: number | null }) {
  const router = useRouter();
...
function StatusDropdown({ entryId, status, showRemove = true }: { entryId: string; status: EntryStatus; showRemove?: boolean }) {
  const router = useRouter();
