...
export function CopyProfileUrl({ handle }: { handle: string }) {
  ...
  return (
    <button
      type="button"
      onClick={copy}
      className="group/copy relative flex h-7 w-7 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-muted hover:text-app-muted"
    >
